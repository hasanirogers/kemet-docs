...
class DocsIntroCards extends LitElement {
  ...
  constructor() {
    ...
    this.cards = [];
    this.brand = localStorage.getItem('fds-docs-brand') ? localStorage.getItem('fds-docs-brand') : 'ford';

    document.addEventListener('docs-brand-change', (event) => this.handleBrandChange(event));
  }
